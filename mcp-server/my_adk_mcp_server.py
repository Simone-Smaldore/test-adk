...
from tools.custom_calculator import custom_calculator
...
adk_tool_calculator_to_expose = FunctionTool(custom_calculator)
print(f"ADK tool '{adk_tool_to_expose.name}' initialized and ready to be exposed via MCP.")
print(f"ADK tool '{adk_tool_calculator_to_expose.name}' initialized and ready to be exposed via MCP.")
# --- End ADK Tool Prep ---
...
async def list_mcp_tools() -> list[mcp_types.Tool]:
    ...
    mcp_tool_schema_2 = adk_to_mcp_tool_type(adk_tool_calculator_to_expose)
    print(f"MCP Server: Advertising tool: {mcp_tool_schema.name}")
    print(f"MCP Server: Advertising tool: {mcp_tool_schema_2.name}")
    return [mcp_tool_schema, mcp_tool_schema_2]
