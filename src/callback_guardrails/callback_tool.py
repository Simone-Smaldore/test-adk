...
def block_paris_tool_guardrail(tool: BaseTool, args: Dict[str, Any],
    ...
    if tool_name == target_tool_name:
        ...
        if city_argument and city_argument.lower() == blocked_city:
            ...
            return {
                ...
                "error",
                "error_message":
                f"Policy restriction: Weather checks for '{city_argument.capitalize()}' are currently disabled by a tool guardrail."
            }
        else:
            print(
